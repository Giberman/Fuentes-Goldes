...
<?php
echo "<link href=\"cv.css\" rel=\"stylesheet\" type=\"text/css\" >";
$conexion = mysqli_connect("localhost", "root", "", "goldes") or
die("Problemas con la conexión");
mysqli_query($conexion, "insert into contactos(nombre, apellido, email, comentario) values
('$_REQUEST[nombre]', '$_REQUEST[apellido]', '$_REQUEST[email]', '$_REQUEST[comentario]')")
or die("Problemas " . mysqli_error($conexion));
mysqli_close($conexion);
echo "<h3 class=\"registro\">Los datos fueron enviados correctamente.</br></br>";
?>
    <input type="submit" name="Volver" value="Volver" onclick="location.href='index.html';" id="volver" class="btn btn-success btn-lg">
</div>
  <!-- Footer -->
